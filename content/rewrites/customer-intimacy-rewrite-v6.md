...
### Complication
- Cross-traffic in busy hallways confuses entry counts
- Subdividing rooms break the assumption that sensor counts add to
  a constant total
- Winter sunlight at low angles degrades image processing
...
### Complication
- Noticed odd behavior before the building opened
- Expanded the data aperture: HVAC running 24/7 as if fully occupied
- A configuration error bleeding money invisibly
